...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2022 a las 21:22:54
...
INSERT INTO `bonos_extras` (`id`, `id_pago_extra`, `id_usuario`, `id_campana`) VALUES
(159, 128, 30, 13),
(160, 128, 52, 13);
...
(13, 'Bono Extra', 10000, 1, 2, 0, '2022-11-14 00:00:00', '2022-12-10 00:00:00', '2022-12-12'),
...
(16, 'vistas/img/comprobantes/879788/878.png', '2022-11-25 19:54:46', 0, 150000, 879788, 4),
(17, 'vistas/img/comprobantes/879788/413.jpg', '2022-11-23 15:20:32', 2, 350000, 879788, 10),
(18, 'vistas/img/comprobantes/43/176.png', '2022-11-23 15:20:33', 2, 80000, 43, 4),
...
(24, 'vistas/img/comprobantes/89875/514.png', '2022-12-02 21:35:48', 1, 90000, 89875, 1),
(25, 'vistas/img/comprobantes/89875/198.png', '2022-12-02 21:36:01', 1, 89000, 89875, 1),
...
(31, 'vistas/img/comprobantes/234234234/555.png', '2022-12-01 22:52:31', 2, 150000, 234234234, 10),
...
(36, 'vistas/img/comprobantes/34543543/629.png', '2022-11-25 20:46:40', 0, 20000, 34543543, 10),
(37, 'vistas/img/comprobantes/321/533.png', '2022-12-02 21:35:30', 0, 200000, 321, 4),
(38, 'vistas/img/comprobantes/3333/120.png', '2022-12-02 21:41:39', 1, 50000, 3333, 10);
...
(25, 234234, 25, 3233, 'Davivienda', 1, 'otro', '2022-11-17 20:56:18'),
(26, 4694964, 49, 554, 'Davivienda', 1, 'ahorros', '2022-11-23 15:55:21'),
(27, 234324, 31, 324324, 'Bancolombia', 1, 'corriente', '2022-11-24 03:18:56'),
...
INSERT INTO `pagos_comisiones` (`id`, `id_usuario`, `valor`, `estado`, `fecha`) VALUES
(364, 26, 11450, 1, '2022-12-04 20:14:06');
...
INSERT INTO `pagos_extras` (`id`, `id_usuario`, `estado`, `referidos_obtenidos`, `valor`, `fecha`) VALUES
(128, 26, 0, 0, 0, '2022-12-02 21:35:48');
...
(293, 24, 0, '2022-12-02 21:35:48'),
(294, 25, 0, '2022-12-02 21:36:01'),
(295, 38, 0, '2022-12-02 21:41:40');
...
(15, 26, 3, 1, 'admin-trading', 0, '2022-11-24 16:00:51'),
...
(33, 49, 13, 1, 'admin-trading', 0, '2022-11-25 20:36:34'),
...
(1, 1, 'admin', 'Administrador', 'admin@trading.com', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 1, 0, NULL, '2019-10-07', 1, NULL, 'vistas/img/usuarios/1/434.jpg', 'admin-trading', NULL, NULL, NULL, '(573) 218-5749', 'firma', NULL, '2019-09-27 19:13:02'),
...
(36, 234234234, 'usuario', 'Carolina', 'carolina@gmail.com', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 1, 0, NULL, NULL, 1, '38ad84cbc67a6e587e34df5df5bdb41c', NULL, 'carolina-36', 'carlos-31', 'Chile', 'CL', '+56 ', '<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\"><svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"202\" height=\"31\"><path stroke-linejoin=\"round\" stroke-linecap=\"round\" stroke-width=\"1\" stroke=\"#333\" fill=\"none\" d=\"M 29 7 c -0.35 -0.1 -13.52 -4.61 -20 -6 c -2.48 -0.53 -8.14 -0.01 -8 0 c 0.49 0.02 18.31 0.93 28 1 c 37.72 0.28 107.09 0.02 109 0 c 0.14 0 -5.48 -1.22 -8 -1 c -4.79 0.42 -10.12 1.58 -15 3 c -5.45 1.58 -11.34 3.48 -16 6 c -2.9 1.57 -7.57 5.27 -8 7 c -0.29 1.15 3.11 4.14 5 5 c 4.75 2.16 11.24 3.98 17 5 c 9.15 1.63 18.48 2.68 28 3 c 20.27 0.69 60 0 60 0\"/></svg>', '2022-10-03', '2022-10-19 02:51:58'),
...
--
ALTER TABLE `red_binaria`
  MODIFY `id_binaria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `red_uninivel`
--
ALTER TABLE `red_uninivel`
  MODIFY `id_uninivel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
