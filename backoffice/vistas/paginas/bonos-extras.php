...
<div class="content-wrapper" style="min-height: 1058.31px;">
  ...
  <section class="content-header">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Campañas Bonos Extras</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
            <li class="breadcrumb-item active">Campañas / Bonos extras</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-header">
        ...
        <h3 class="card-title">Bonos extras registrados</h3>

        <?php if ($usuario["perfil"] == "admin"): ?>

        <div style="margin:1em auto auto auto">

            <button class="btn btn-primary" data-toggle="modal" data-target="#modalRegistrarCampana">Registrar Bono Extra</button>
      ...
      <div class="card-body">
        ...
        <table id="tablaCampanasBonosExtras" class="table table-striped table-bordered dt-responsive tablaCampanasBonosExtras" width="100%">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form method="post">
          ...
          <input type="hidden" name="tipoCampanaEditar" value="2"></input>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form method="post" enctype="multipart/form-data">
	      ...
	      <!-- Modal Header -->
	      <div class="modal-header">
	        <h4 class="modal-title">Registrar Bono extra</h4>
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	      </div>
        ...
        <input type="hidden" name="tipoCampana" value="2"></input>
