...
$pagos = ControladorPagos::ctrMostrarPagosComisiones(null, null);
$total_a_pagar=0;
$total_pagos=0;
...
<div class="row">
	...
	<div class="col-12 col-sm-6 col-lg-3">
		...
		<div class="small-box bg-info">
			...
			<a href="pagos-comisiones" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
	...
	<div class="col-12 col-sm-6 col-lg-3">
		...
		<div class="small-box bg-purple">
			...
			<a href="comisiones-pagadas" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
